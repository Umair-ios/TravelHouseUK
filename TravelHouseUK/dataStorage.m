...
@implementation dataStorage{
    int temptotallInfants;
}
static dataStorage *sharedAwardCenter = nil;    // static instance variable
@synthesize pessengersArray,personalArray,totallPessengers,totallInfants,totallAdults,totallChilds,itenArray,searchQuery,requestItenary,sessionId,Description,Amount,dataArray,image,temptotallInfants;
@synthesize child,infant,totallAdultFare,totallChildFare,totallInfantFare;
        ...
        while(i<totallAdults)
        {
            ...
            if (temptotallInfants!=0) {
                ...
                paxDetails=[NSString stringWithFormat:@"%@<Adult>\n"
                            ...
                            "</Adult>\n",paxDetails,i+1,fname,lname,dob,gender,passport,temptotallInfants];
